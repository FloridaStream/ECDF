 ...
 */
public class AccessRules implements DataModel, Serializable {
    ...
    public static class Devices implements DataModel, Serializable {
    ...
    public static class Cellular implements DataModel, Serializable {
    ...
    public static class Geo implements DataModel, Serializable {
    ...
    public static class ClosedAccess implements DataModel, Serializable {
